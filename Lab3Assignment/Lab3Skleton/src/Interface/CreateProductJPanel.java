...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
       ...
       if (txtProdName.getText().isEmpty()) // Check if the field is empty, if not cant create
       {
           try
        {
            Integer.parseInt(txtProdName.getText());
        }
        catch (Exception p)
        {
...
p=prodDir.searchAccount(txtProdName.getText());
if (p!=null)
{
...
return;
      ...
      /* try
        ...
        {
        JOptionPane.showMessageDialog(null, "Product name can  only in string. Please enter in String");
            return;
        }*/
